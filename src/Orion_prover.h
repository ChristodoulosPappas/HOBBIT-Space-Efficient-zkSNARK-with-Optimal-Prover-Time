...
#include "virgo_circuit_fast_track.h"
...
public:
	...
	* Some randomness or values during the proof phase. */
	...
	linear_poly2 *addV_array;
	linear_poly2 *V_mult_add;
	...
	void get_circuit(_layered_circuit &from_verifier);
	...
	*3. final round for the extra mask bit
	...
	quadratic_poly2 sumcheck_phase1_update(prime_field::field_element, int);
	quadratic_poly2 sumcheck_phase2_update(prime_field::field_element, int);
