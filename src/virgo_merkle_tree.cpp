...
int merkle_tree_virgo::size_after_padding;

__hhash_digest merkle_tree_virgo::hash_single_field_element(prime_field::field_element x)
{
...
__hhash_digest merkle_tree_virgo::hash_double_field_element_merkle_damgard(prime_field::field_element x, prime_field::field_element y, __hhash_digest prev_hash)
{
   __hhash_digest data[2], ret;
    data[0] = prev_hash;
...
void merkle_tree_virgo::merkle_tree_prover::create_tree(void* src_data, int ele_num, __hhash_digest* &dst, const int element_size = 256 / 8, bool alloc_required = false)
{
...
bool merkle_tree_virgo::merkle_tree_verifier::verify_claim(__hhash_digest root_hhash, const __hhash_digest* tree, __hhash_digest leaf_hash, int pos_element_arr, int N, bool *visited, long long &proof_size)
{
