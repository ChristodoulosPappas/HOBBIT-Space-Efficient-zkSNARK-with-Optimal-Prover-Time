...
void zk_prover::get_circuit(_layered_circuit &from_verifier)
{
	C = &from_verifier;
...
linear_poly2 *V_mult_add_new, *addV_array_new, *add_mult_sum_new;
bool gate_meet[15];
quadratic_poly2 *rets_prev, *rets_cur;
void zk_prover::init_array(int max_bit_length)
{
	...
	V_mult_add_new = new linear_poly2[1 << max_bit_length];
	addV_array_new = new linear_poly2[1 << max_bit_length];
	add_mult_sum_new = new linear_poly2[1 << max_bit_length];
	rets_prev  = new quadratic_poly2[1 << max_bit_length];
	rets_cur = new quadratic_poly2[1 << max_bit_length];
}
...
//new zk function
quadratic_poly2 zk_prover::sumcheck_phase1_update(prime_field::field_element previous_random, int current_bit)
{	
	std::chrono::high_resolution_clock::time_point t0 = std::chrono::high_resolution_clock::now();
...
void zk_prover::sumcheck_phase2_init(prime_field::field_element previous_random, const prime_field::field_element* r_u, const prime_field::field_element* one_minus_r_u)
{
	...
	v_u = V_mult_add[0].eval2(previous_random);
...
quadratic_poly2 zk_prover::sumcheck_phase2_update(prime_field::field_element previous_random, int current_bit)
{
	std::chrono::high_resolution_clock::time_point t0 = std::chrono::high_resolution_clock::now();
	quadratic_poly2 ret = quadratic_poly2(prime_field::field_element(0), prime_field::field_element(0), prime_field::field_element(0));
	#pragma omp parallel for
...
{
	v_v = V_mult_add[0].eval2(previous_random);
